                   ...
                   <div class="card-body card-block">
                        <form action="{{route('newJob')}}" method="post" class="form-horizontal">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text"  name="job_position" placeholder="Text" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <textarea  name="job_description" placeholder="Content..." class="form-control"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text"  name="closing_date" placeholder="Text" class="form-control">
                                </div>
                            </div>
